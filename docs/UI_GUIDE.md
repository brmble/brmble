...
| **UI — Actions** | `x`, `search`, `plus`, `minus`, `check`, `send`, `upload`, `refresh-cw`, `arrow-right`, `eye`, `eye-off`, `chevron-up`, `chevron-down`, `chevron-left`, `chevron-right`, `info`, `info-filled` | Generic interactive icons |
