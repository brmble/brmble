...
export function UserPanel({ username, onToggleDM, dmActive, unreadDMCount, onOpenSettings, muted, deafened, leftVoice, onToggleMute, onToggleDeaf, onLeaveVoice, speaking }: UserPanelProps) {
  return (
